    ...
    TokenTest
{
    ...
    /// @dev tests that _resolveMintsForEthBlast applies collection mint multipliers correctly
    function test_resolveMintsForEthBlastAppliesCollectionMintMultipliersCorrectly()
        external
    {
