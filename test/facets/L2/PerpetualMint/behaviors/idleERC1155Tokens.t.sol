    ...
    L2ForkTest
{
    ...
    /// @dev tests that if there are pending mint requests idling ERC1155 tokens reverts
    function test_idleERC1155TokensRevertsWhen_ThereIsAtLeastOnePendingRequest()
        public
    {
