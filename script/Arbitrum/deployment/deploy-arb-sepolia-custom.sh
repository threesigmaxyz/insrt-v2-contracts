...
CHAIN_ID=421614
DEPLOYMENT_SCRIPTS=("01_deployInsrtVRFCoordinator.s.sol" "01_deployToken.s.sol" "01_deployPerpetualMint.s.sol")
...
forge script script/common/deployment/${DEPLOYMENT_SCRIPTS[1]} --rpc-url $RPC_URL --verify --broadcast --verifier-url $VERIFIER_URL
forge script script/Arbitrum/deployment/${DEPLOYMENT_SCRIPTS[2]} --rpc-url $RPC_URL --verify --broadcast --verifier-url $VERIFIER_URL
