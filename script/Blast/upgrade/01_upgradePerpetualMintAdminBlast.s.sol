...
/// @title UpgradePerpetualMintAdminBlast
/// @dev Deploys a new PerpetualMintAdminBlast facet and signs and submits a diamondCut of the PerpetualMintAdminBlast facet
/// to the CoreBlast diamond via the Gnosis Safe Transaction Service API
contract UpgradePerpetualMintAdminBlast is BatchScript {
    ...
    function run() external {
        ...
        console2.log("CoreBlast Address: ", coreBlast);
        ...
        addToBatch(coreBlast, diamondCutTx);
