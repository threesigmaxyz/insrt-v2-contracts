...
export MINT_TOKEN_TIER_MULTIPLIERS="200000000,350000000,950000000,1750000000,10000000000" # 0.2x, 0.35x, .95x, 1.75x, 10x (1e9)
export MINT_TOKEN_TIER_RISKS="500000000,330000000,125000000,40000000,5000000" # 50%, 33%, 12.5%, 4%, 0.5% (1e7)
export NEW_PERP_MINT_OWNER="0x554BcBB65E21bF15dbAdD8c381F4A386efdcbf23"
